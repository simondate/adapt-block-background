  ...
  var BlockBackgroundView = Backbone.View.extend({
    ...
    setBackgroundGraphic: function($blockElement, options) {
      if (Adapt.device.screenSize === 'large') {
        $blockElement.addClass('block-background-block').remove('block-background-block-mobile').css({
        ...
        $blockElement.addClass('block-background-block-mobile').remove('block-background-block').css({
